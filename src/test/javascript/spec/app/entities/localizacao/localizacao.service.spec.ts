...
describe('Service Tests', () => {
    describe('Localizacao Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Localizacao(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Localizacao', async () => {
            ...
            it('should return a list of Localizacao', async () => {
                const returnedFromService = Object.assign(
                    {
                        streetAddress: 'BBBBBB',
                        postalCode: 'BBBBBB',
            ...
            it('should delete a Localizacao', async () => {
