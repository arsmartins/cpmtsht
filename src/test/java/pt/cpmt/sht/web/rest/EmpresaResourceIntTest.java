...
public class EmpresaResourceIntTest {
    ...
    public void createEmpresa() throws Exception {
        ...
        assertThat(testEmpresa.getStartDate()).isEqualTo(DEFAULT_START_DATE);
        assertThat(testEmpresa.getEndDate()).isEqualTo(DEFAULT_END_DATE);
        assertThat(testEmpresa.getLanguage()).isEqualTo(DEFAULT_LANGUAGE);
    }
    ...
    public void updateEmpresa() throws Exception {
        ...
        Empresa testEmpresa = empresaList.get(empresaList.size() - 1);
        assertThat(testEmpresa.getStartDate()).isEqualTo(UPDATED_START_DATE);
        assertThat(testEmpresa.getEndDate()).isEqualTo(UPDATED_END_DATE);
        assertThat(testEmpresa.getLanguage()).isEqualTo(UPDATED_LANGUAGE);
    }
