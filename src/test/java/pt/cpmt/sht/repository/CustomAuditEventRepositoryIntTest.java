...
import pt.cpmt.sht.config.audit.AuditEventConverter;
import pt.cpmt.sht.domain.PersistentAuditEvent;
...
import static pt.cpmt.sht.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
